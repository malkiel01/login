        ...
        if (iframeFormTypes.includes(type)) {
            if (typeof PopupManager !== 'undefined') {
                const formConfigs = {
                    ...
                    country: {
                        file: 'countryForm-iframe.php',
                        titleNew: 'הוספת מדינה חדשה',
                        titleEdit: 'עריכת מדינה',
                        width: 600,
                        height: 400
                    },
                    city: {
                        file: 'cityForm-iframe.php',
                        titleNew: 'הוספת עיר חדשה',
                        titleEdit: 'עריכת עיר',
                        width: 600,
                        height: 450
                    }
    ...
    handleBurialForm: function(itemId) {
        ...
        (async function loadAvailableCustomers() {
            try {
                ...
                // ⭐ אכלס לקוחות
                populateCustomersB(result.data);
