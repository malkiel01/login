...
class TableManager {
    ...
    showLoadingIndicator() {
        ...
        // צור overlay שקוף לגמרי - רק ספינר וטקסט
        ...
        overlay.innerHTML = `
            ...
            <div style="margin-top: 20px; font-size: 18px; font-weight: 600; color: var(--primary-color, #667eea); text-shadow: 0 0 8px white, 0 0 16px white;">
                טוען נתונים...
            </div>
        `;
    ...
    _initResizing() {
        ...
        const onMouseMove = (e) => {
            ...
            // ⭐ גם כפיית רוחב על TH ישירות (למקרה שהדפדפן לא מכבד colgroup)
            if (currentTh) {
            ...
            // ⭐ עדכון רוחב הטבלה בזמן הגרירה - מונע התרחבות עמודות אחרות
