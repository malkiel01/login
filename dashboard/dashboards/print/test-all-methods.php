...
async function testMethod(method) {
    ...
    try {
        ...
        if (result.success) {
            ...
            // אם זה HTML או PS, הוסף הערה
            if (result.method && result.method.includes('HTML')) {
                resultDiv.innerHTML += '<p style="color: #666; font-size: 0.9em; margin-top: 10px;">💡 טיפ: השתמש ב-Ctrl+P כדי להדפיס ל-PDF</p>';
            } else if (result.method && result.method.includes('PostScript')) {
                resultDiv.innerHTML += '<p style="color: #666; font-size: 0.9em; margin-top: 10px;">💡 טיפ: המר ל-PDF עם <a href="https://ps2pdf.com/" target="_blank">ps2pdf.com</a></p>';
            }
        } else {
