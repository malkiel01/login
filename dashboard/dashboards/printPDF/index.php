...
<html lang="he" dir="rtl">
    ...
    <body>
        ...
        <!-- IMPORTANT: Load ONLY ONE version of each file -->
        <!-- Option 1: Use the fixed versions (recommended) -->
        <script src="assets/js/api-connector-fixed.js"></script>
        <script src="assets/js/cloud-save-manager-fixed.js"></script>
        
        <!-- Option 2: OR use the original versions if you haven't created the fixed files yet
                        ...
                        setTimeout(() => {
                            ...
                            if (typeof PDFEditorApp !== 'undefined') {
                                try {
                                    ...
                                    // Initialize cloud save manager with API connector
