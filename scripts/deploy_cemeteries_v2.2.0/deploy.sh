#!/usr/bin/env bash
# קובץ: $HOME/public_html/form/login/scripts/deploy_cemeteries_v2.2.0/deploy.sh
# מטרה: פריסת תיקון למודול בתי עלמין - מניעת התנגשות עם לקוחות
# תאריך: 2025-10-24
# גרסה: v2.2.0
# 
# שלבי פעולה:
# 1. בדיקת קיום נתיבים
# 2. יצירת גיבוי אוטומטי
# 3. פריסת קובץ מעודכן
# 4. רישום לוג מפורט
# 
# הוראות שחזור:
...
# ========================================
log "🚀 ========================================="
log "🚀 התחלת פריסה $VERSION - תיקון בתי עלמין"
log "🚀 ========================================="
...
log ""
log "📝 השינוי שבוצע:"
log "  • שינוי שם הפונקציה initUniversalSearch() ל-initCemeteriesUniversalSearch()"
log "  • מניעת התנגשות עם מודול הלקוחות"
log ""
log "📝 הערות:"
...
log "✅ כעת ניתן לעבור בין בתי עלמין ללקוחות ללא בעיות!"
